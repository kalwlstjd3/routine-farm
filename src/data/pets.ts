...
export const PETS: PetDefinition[] = [
  // ── 알/부화 시작 4종 ──────────────────────────────────────────
  {
    ...
    stages: {
      ...
      adult:    { emoji: '🐔', label: '성체',        bg: '#FFF3E0' },
  ...
  },
  {
    ...
    stages: {
      ...
      adult:    { emoji: '🐢', label: '거북이 성체',   bg: '#C8E6C9' },
      hungry:   { emoji: '😢', label: '배고파요',      bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',          bg: '#F5F5F5' },
    },
  },
  {
    ...
    stages: {
      ...
      adult:    { emoji: '🦜', label: '앵무새 성체',   bg: '#E8EAF6' },
      hungry:   { emoji: '😢', label: '배고파요',      bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',          bg: '#F5F5F5' },
    },
  },
  {
    ...
    stages: {
      ...
      adult:    { emoji: '🦆', label: '오리 성체',   bg: '#F9FBE7' },
      hungry:   { emoji: '😢', label: '배고파요',    bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',        bg: '#F5F5F5' },
    },
  },
  ...
  // ── 아기부터 시작 6종 ──────────────────────────────────────────
  {
    ...
    stages: {
      ...
      growing:  { emoji: '😺', label: '조금 자랐어요',   bg: '#FFE0B2' },
      juvenile: { emoji: '😸', label: '청년 고양이',     bg: '#FFCC80' },
      adult:    { emoji: '😻', label: '완전 성체',       bg: '#FFB74D' },
      hungry:   { emoji: '😢', label: '배고파요',        bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',            bg: '#F5F5F5' },
    },
  },
  {
    ...
    stages: {
      ...
      growing:  { emoji: '😺', label: '조금 자랐어요',   bg: '#BBDEFB' },
      juvenile: { emoji: '😸', label: '청년 고양이',     bg: '#90CAF9' },
      adult:    { emoji: '😻', label: '완전 성체',       bg: '#64B5F6' },
      hungry:   { emoji: '😢', label: '배고파요',        bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',            bg: '#F5F5F5' },
    },
  },
  {
    ...
    stages: {
      ...
      growing:  { emoji: '🐕', label: '조금 자랐어요',   bg: '#FFECB3' },
      juvenile: { emoji: '🐩', label: '청년 강아지',     bg: '#FFE082' },
      adult:    { emoji: '🐩', label: '완전 성체',       bg: '#FFD54F' },
      hungry:   { emoji: '😢', label: '배고파요',        bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',            bg: '#F5F5F5' },
    },
  },
  {
    ...
    stages: {
      ...
      growing:  { emoji: '🐕', label: '조금 자랐어요',   bg: '#FFE0B2' },
      juvenile: { emoji: '🦮', label: '청년 강아지',     bg: '#FFCC80' },
      adult:    { emoji: '🦮', label: '완전 성체',       bg: '#FFA726' },
      hungry:   { emoji: '😢', label: '배고파요',        bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',            bg: '#F5F5F5' },
    },
  },
  {
    ...
    stages: {
      ...
      growing:  { emoji: '🐕', label: '조금 자랐어요',   bg: '#FFCCBC' },
      juvenile: { emoji: '🐕', label: '청년 강아지',     bg: '#FFAB91' },
      adult:    { emoji: '🐕', label: '완전 성체',       bg: '#FF8A65' },
      hungry:   { emoji: '😢', label: '배고파요',        bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',            bg: '#F5F5F5' },
    },
  },
  {
    ...
    stages: {
      ...
      growing:  { emoji: '🐹', label: '조금 자랐어요',   bg: '#F8BBD0' },
      juvenile: { emoji: '🐹', label: '청년 햄스터',     bg: '#F48FB1' },
      adult:    { emoji: '🐭', label: '완전 성체',       bg: '#F06292' },
      hungry:   { emoji: '😢', label: '배고파요',        bg: '#FFF0F0' },
      fainted:  { emoji: '😵', label: '기절',            bg: '#F5F5F5' },
    },
  },
